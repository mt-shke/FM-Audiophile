import { validateLength, validateEmail, validateNumber } from "../utils/formValidation";
...
const Form = (props) => {
	return (
		<form
			...
			className="flex-c6 p-6 bg-white rounded-lg md:grid md:col-start-1 md:col-end-4 lg:p-12 xl:col-start-1 xl:col-end-3"
		>
			<h2>checkout</h2>
			<div>
				...
				<div className="md:grid md:grid-cols-2 md:gap-x-4 md:gap-y-2">
					...
					<LabelInput label="Phone Number" id="phone" name="phone" validation={validateNumber} />
				</div>
			</div>
			<div>
				...
				<div className="md:grid md:grid-cols-2 md:gap-x-4 md:gap-y-2">
					...
					/>
					<LabelInput label="ZIP Code" id="ZIPCode" name="ZIPCode" validation={validateNumber} />
