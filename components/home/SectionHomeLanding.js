	...
	return (
		<div className="relative w-full flex items-center bg-black">
			<section className="ctn home-landing relative w-full flex items-center">
				<Background className="absolute z-10 bg-gradient-to-b from-black via-transparent to-black opacity-90" />
				<Background className="hidden absolute z-[9] bg-gradient-to-r from-black via-transparent to-black opacity-90 sm:block" />
